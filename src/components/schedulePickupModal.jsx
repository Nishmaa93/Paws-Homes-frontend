    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white rounded-lg p-6 max-w-sm w-full shadow-lg">
                <h2 className="text-2xl font-bold mb-4 text-black">Schedule A Pickup</h2>
                <div className="mb-4">
                    <label className="block text-black mb-2" htmlFor="date">Pick a Date</label>
                    <input
                        type="date"
                        id="date"
                        value={date}
                ...
                <div className="mb-4">
                    <label className="block text-black mb-2" htmlFor="timeSlot">Pick a Time Slot (1-8) PM</label>
                    <input
                        type="number"
                        id="timeSlot"
                        value={timeSlot}
                ...
                <button
                    onClick={handleSubmit}
                    className="w-full bg-[#E0D082] text-black py-2 rounded hover:bg-[#d4c074] transition-colors"
                >
                    Done
                </button>
            </div>
