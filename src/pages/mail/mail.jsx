...
const Mail = () => {
  ...
  const renderContent = () => {
    if (isLoading) {
      return <p className="text-center text-xl text-black">Loading...</p>;
    }
  ...
  return (
    <div className="min-h-screen bg-[#E0D082]">
      <Navbar />
      <div className="container mx-auto p-6 pt-32">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold text-center text-black mb-8">My Inbox</h1>
          {renderContent()}
        </div>
      </div>
      <SchedulePickupModal
